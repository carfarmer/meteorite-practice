...
my_loc = (47.800778, -122.189718)

meteor_resp = requests.get('https://data.nasa.gov/resource/gh4g-9sfh.json')
meteor_data = meteor_resp.json()

#meteor_lat = float(meteor_data[0]['reclat'])
#meteor_lon = float(meteor_data[0]['reclong'])
